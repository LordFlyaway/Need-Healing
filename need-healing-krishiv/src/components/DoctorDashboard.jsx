...
export default function DoctorDashboard({ user }) {
  ...
  const requestDeleteRecord = async (record) => {
    if (!activeSession) return;
    ...
    try {
      await addDoc(collection(db, "access_requests"), {
        ...
        payload: {
          ...
          recordTitle: record.medication || record.allergen || record.condition || record.procedure || record.test_name || record.label || 'Record',
        }
      });
      toast.success("Delete request sent to patient for approval.");
    } catch (err) {
        ...
        <div className="doctor-connect-section">
          <div className="card doctor-terminal-card">
            <div className="doctor-terminal-header">
              <div className="doctor-terminal-icon">ID</div>
              <div>
            ...
            <div className="doctor-input-group">
              ...
              {requestState === 'pending' ? (
                ...
                <div className="doctor-denied-state">
                  <span className="doctor-denied-icon">X</span>
                  <div>
